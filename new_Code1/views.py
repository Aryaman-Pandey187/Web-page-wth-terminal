...
# I just need the new ones to be displayed - check chat GPT - DONE
# redirect to a new page, once all verifications are done - DONE
# how to deploy django code in production
# use docker with django
# expose URL of django app - can I use ngrok to expose URL of django app



# check if target table and source table schema is same? -  add this to prakirns code?